...
class ContentStyleModel(BaseModel):
    ...
    def __init__(self, opt, base_init=True):
        ...
        self.visual_names += ['real_A', 'mask_A', 'real_B', 'mask_B', 'rec_A', 'rec_B', 'fake_A', 'fake_B']
    ...
    def backward_GE(self):
        ...
        self.loss_cycle_B = self.critCycle(self.real_B, self.rec_B) * self.opt.lambda_cycle_B
        ...
        self.loss_cycle_A = self.critCycle(self.real_A, self.rec_A) * self.opt.lambda_cycle_A
