...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--display_port', type=int, default=8964, help='visdom display port')
        parser.add_argument('--update_html_freq', type=int, default=400, help='frequency of saving training results to html')
        parser.add_argument('--print_freq', type=int, default=40, help='frequency of showing training results on console')
