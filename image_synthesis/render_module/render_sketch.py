try:
    ...
    from render_module.vtn.vtn.functions import grid_sample3d, affine_grid3d
try:
    from .calc_prob.calc_prob.functions.calc_prob import CalcStopProb
except ImportError:
    from render_module.calc_prob.calc_prob.functions.calc_prob import CalcStopProb
...
class FineSizeCroppingLayer(nn.Module):
    ...
    def __init__(self, output_size):
        super(FineSizeCroppingLayer, self).__init__()
...
class VoxelRenderLayer(nn.Module):
    def __init__(self, voxel_shape, camera_distance=2.0, fl=0.050, w=0.0612, res=128, nsamples_factor=1.5):
        super(VoxelRenderLayer, self).__init__()
